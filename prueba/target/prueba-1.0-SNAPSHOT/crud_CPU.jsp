...
<html>
    ...
    <body class="body">
        ...
        <div class="text-center">
            <h1 class="titulo_letter">Tabla de Procesadores</h1> 
        </div>
        ...
        <script>
            ...
            document.getElementById("redireccionar").addEventListener("click", function () {
                window.location.href = "For_agregar_cpu.jsp"; // Reemplaza con la URL de tu página de formulario de agregado
            });
            ...
            actualizarButtons.forEach(function (button) {
                button.addEventListener("click", function () {
                    ...
                    window.location.href = "FormularioActualizar_cpu.jsp?id=" + rowID; // Reemplaza con tu lógica específica
                });
            });
        </script>
        ...
        <script>
            ...
            eliminarButtons.forEach(function (button) {
                button.addEventListener("click", function () {
                    ...
                    xhr.open("POST", "EliminarCPU.jsp", true);
