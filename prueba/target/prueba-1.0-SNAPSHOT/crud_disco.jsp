<%-- 
    Document   : crud_disco
    Created on : 3 oct. 2023, 22:11:28
    Author     : Bryan
--%>
...
<html>
    ...
    <body class="body">
        ...
        <div class="text-center">
            <h1 class="titulo_letter">Tabla de Discos</h1> 
        </div>
        ...
        <%
            ...
            try {
                ...
                ResultSet rs = stmt.executeQuery("SELECT * FROM discoduro");
        %>
        <div class="container">
        ...
        <script>
            ...
            document.getElementById("redireccionar").addEventListener("click", function () {
                window.location.href = "For_agregar_disco.jsp"; // Reemplaza con la URL de tu página de formulario de agregado
            });
            ...
            actualizarButtons.forEach(function (button) {
                button.addEventListener("click", function () {
                    ...
                    window.location.href = "FormularioActualizar_disco.jsp?id=" + rowID; // Reemplaza con tu lógica específica
                });
            });
        </script>
        ...
        <script>
            ...
            eliminarButtons.forEach(function (button) {
                button.addEventListener("click", function () {
                    ...
                    xhr.open("POST", "Eliminardisco.jsp", true);
