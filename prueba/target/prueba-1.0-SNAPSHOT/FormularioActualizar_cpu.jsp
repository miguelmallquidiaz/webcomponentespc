<%-- 
    Document   : FormularioActualizar_cpu
    Created on : 4 oct. 2023, 21:39:40
    Author     : Bryan
--%>
...
<html>
    ...
    <body>
        <div class="container mt-5">
            <h1>Actualizar</h1>
            <form action="Procesar_cpu.jsp" method="post">
                <div class="mb-3">
            ...
            <%
                ...
                String usuario = "root";
                String contraseña = "";
                String sentenciaSQL = "SELECT Nombre, Stock, Imagen, Precio FROM cpu WHERE ID = ?";
