<%-- 
    Document   : Procesar_disco
    Created on : 4 oct. 2023, 21:47:43
    Author     : Bryan
--%>

<%-- 
    Document   : Procesar_cpu
    Created on : 4 oct. 2023, 21:43:47
    Author     : Bryan
--%>
...
<body>
    <div class="container mt-5">
        ...
        <%
            ...
            String sentenciaSQL = "UPDATE discoduro SET Nombre = ?, Stock= ?, Imagen = ?, Precio = ? WHERE ID = ?";
        ...
        <p><a href="crud_disco.jsp">Volver a la lista de productos</a></p>
        <%
                } else {
        %>
