<%-- 
    Document   : For_agregar_memoria
    Created on : 4 oct. 2023, 19:48:30
    Author     : Bryan
--%>

<%-- 
    Document   : For_agregar_disco
    Created on : 4 oct. 2023, 19:48:16
    Author     : Bryan
--%>

<%-- 
    Document   : For_agregar_cpu
    Created on : 4 oct. 2023, 19:48:00
    Author     : Bryan
--%>
        ...
        <div class="container mt-5">
            ...
            <%
                ...
                if (request.getMethod().equalsIgnoreCase("POST")) {
                    ...
                    String sentenciaSQL = "INSERT INTO memoria (Nombre, Stock, Img, Precio) VALUES (?, ?, ?, ?)";
            ...
            <script>
                ...
                window.location.href = "crud_memoria.jsp"; // Reemplaza "crud_memoria.jsp" con la URL de tu página principal
            </script>
            <%
            } else {
                // Muestra una alerta con JavaScript
