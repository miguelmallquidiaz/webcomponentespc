...
<html>
    ...
    <body>
        ...
        <div class="container mt-5">
            <h1>Agregar nuevo Procesador</h1>
            ...
            <%
                ...
                if (request.getMethod().equalsIgnoreCase("POST")) {
                    ...
                    String sentenciaSQL = "INSERT INTO cpu (Nombre, Stock, Imagen, Precio) VALUES (?, ?, ?, ?)";
            ...
            <script>
                ...
                window.location.href = "crud_CPU.jsp"; // Reemplaza "crud_memoria.jsp" con la URL de tu página principal
            </script>
            <%
            } else {
                // Muestra una alerta con JavaScript
