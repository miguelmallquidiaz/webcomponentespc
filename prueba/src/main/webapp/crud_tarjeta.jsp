<%-- 
    Document   : crud_memoria
    Created on : 29 set. 2023, 20:43:03
    Author     : Bryan
--%>
...
<html>
    ...
    <body class="body">
        ...
        <div class="text-center">
            <h1 class="titulo_letter">Tabla de Tarjetas</h1> 
        </div>
        ...
        <%
            String url = "jdbc:mysql://localhost:33065/aplicativo_computer"; // Cambia la URL y el puerto según tu configuración
            ...
            try {
                ...
                ResultSet rs = stmt.executeQuery("SELECT * FROM tarjetagrafica");
        %>
        <div class="container">
        ...
        <script>
            ...
            document.getElementById("redireccionar").addEventListener("click", function () {
                window.location.href = "For_agregar_tarjeta.jsp"; // Reemplaza con la URL de tu página de formulario de agregado
            });
            ...
            actualizarButtons.forEach(function (button) {
                button.addEventListener("click", function () {
                    ...
                    window.location.href = "FormularioActualizar_tarjeta.jsp?id=" + rowID; // Reemplaza con tu lógica específica
                });
            });
        </script>
        ...
        <script>
            ...
            eliminarButtons.forEach(function (button) {
                button.addEventListener("click", function () {
                    ...
                    xhr.open("POST", "Eliminartarjeta.jsp", true);
