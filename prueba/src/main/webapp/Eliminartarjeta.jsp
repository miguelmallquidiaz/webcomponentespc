<%-- 
    Document   : Eliminartarjeta
    Created on : 4 oct. 2023, 19:29:39
    Author     : Bryan
--%>

<%-- 
    Document   : Eliminarmemoria
    Created on : 4 oct. 2023, 19:29:24
    Author     : Bryan
--%>

<%-- 
    Document   : Eliminardisco
    Created on : 4 oct. 2023, 19:29:06
    Author     : Bryan
--%>
...
<body>
    <%
        ...
        String sentenciaSQL = "DELETE FROM tarjetagrafica WHERE ID = ?";
