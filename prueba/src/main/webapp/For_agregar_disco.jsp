...
<html>
    ...
    <body>
        ...
        <div class="container mt-5">
            <h1>Agregar nuevo disco duro</h1>
            ...
            <%
                ...
                if (request.getMethod().equalsIgnoreCase("POST")) {
                    ...
                    String sentenciaSQL = "INSERT INTO discoduro (Nombre, Stock, Imagen, Precio) VALUES (?, ?, ?, ?)";
            ...
            <script>
                ...
                window.location.href = "crud_disco.jsp"; // Reemplaza "crud_memoria.jsp" con la URL de tu página principal
            </script>
            <%
            } else {
                // Muestra una alerta con JavaScript
