        ...
        <div class="container mt-5">
            ...
            <%
                ...
                if (request.getMethod().equalsIgnoreCase("POST")) {
                    ...
                    String sentenciaSQL = "INSERT INTO placa (Nombre, Stock, Imagen, Precio) VALUES (?, ?, ?, ?)";
            ...
            <script>
                ...
                window.location.href = "crud_placa.jsp"; // Reemplaza "crud_memoria.jsp" con la URL de tu página principal
            </script>
            <%
            } else {
                // Muestra una alerta con JavaScript
